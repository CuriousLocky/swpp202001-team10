...
// You don't want to touch the code here
...
//   // If you want to add a function-level pass, add FPM.addPass(MyPass()) here.
  ...
  // You only need to add this line. The order of passes will be optimized in
  // Sprint 3 but if you know what you are doing, you are encouraged to optimize
  // it as you want.
  FPM.addPass(Example());
